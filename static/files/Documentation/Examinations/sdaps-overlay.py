...
# Which answers are correct. you can figure this out using:
# * The output of the setup command (it is also in the log file)
# * Using the annotate command and looking at the generated PDF
# * Using the numbering from the PDF it should be correct usually
correct_answers = ['1.1.1', '1.2.1.1', '1.2.2.3', ]
    ...
    for p in xrange(questionnaire.page_count):
        ...
        for qobj in questionnaire.qobjects:
            for box in qobj.boxes:
                ...
                checked = box.data.state
                correct = box.id_str() in correct_answers
                ...
                if not checked and not correct:
                    pass
